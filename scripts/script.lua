...
print(xpcall(function()
	...
	local longText = [[
			500 лет орден янычаров наращивает свою мощь, славу и влияние. 
			Это не устраивало многих правителей.
			При этом множество детей отправляется для обучения с дальнейшим вступления в орден.
			Среди этих детей есть и вы.
	]]
	...
	function setTestItem(unit, Item)
		...
		setItem(T.helm, 'Н', 'armour', {medium = true}, {head=true, neck = true}, Char.createChar('itemChar', {value = {100,  40, 100}}), 'shlem pokritiy volnistimi uzorami')
